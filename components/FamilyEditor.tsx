              ...
              {canEdit && (
                <div className="flex gap-2">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      deleteFamily({ variables: { id: family.id } })
                    }
                  >
                    Delete
                  </Button>
            ...
            {isEditing ? (
              <div className="space-y-3 mb-4">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, marriage_year: e.target.value })
                  }
                />
                <Input
                  type="text"
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, marriage_place: e.target.value })
                  }
                />
                  ...
                  <div className="flex justify-between items-center mb-2">
                    ...
                    {canEdit && (
                      <Button
                        ...
                        onClick={() =>
                          setAddingChildTo(
                            addingChildTo === family.id ? null : family.id,
                          )
                        }
                      >
                  ...
                  {family.children.length > 0 && (
                    <div className="grid md:grid-cols-2 gap-2">
                      {family.children.map((child) => (
                        <div
                          key={child.id}
                          className={`p-3 rounded border-l-4 ${child.sex === 'F' ? 'border-l-pink-300 bg-pink-50/50' : 'border-l-blue-300 bg-blue-50/50'} flex justify-between items-center group`}
                        >
        ...
        <div className="card p-6">
          {showAddFamily ? (
            <div className="space-y-3">
              ...
              <Input
                type="text"
                placeholder="Marriage Date (e.g., 15 Jun 1920)"
                value={formData.marriage_date}
                onChange={(e) =>
                  setFormData({ ...formData, marriage_date: e.target.value })
                }
