    ...
    <div className="max-w-6xl mx-auto">
      <div className="card p-6">
        <div className="flex justify-between items-center mb-4">
          ...
          <p className="text-sm text-gray-500">{queue.length} people in queue</p>
        </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b text-left">
                  <th className="py-2 px-3 text-sm font-semibold w-48">Priority</th>
                      ...
                      <td className="py-3 px-3">
                        <div className="flex items-center gap-2">
                          <span className={`inline-block w-8 h-8 rounded-full text-center leading-8 font-bold text-white ${
                            priority >= 7 ? 'bg-red-500' : priority >= 4 ? 'bg-orange-500' : 'bg-blue-500'
                          }`}>
                            {priority}
                          </span>
                          <input
                            ...
                            max="10"
                            value={priority}
                            onChange={(e) => handlePriorityChange(person.id, parseInt(e.target.value))}
